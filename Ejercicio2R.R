...
diams1<-list(Quilate = diamonds$carat,Corte=diamonds$cut, Color = diamonds$color
...
write.csv(diams1,"diamonds2005.csv")
library("perl")

WriteXLS::WriteXLS(diamonds,ExcelFileName = "diamondsAAA.xlsx",perl = "perl")
